...
import kripsy.fiddlefulfeatures.item.custom.FlanBean;
import kripsy.fiddlefulfeatures.item.custom.WalletWhacker;
import kripsy.fiddlefulfeatures.item.custom.Mattock;
import kripsy.fiddlefulfeatures.item.custom.WizardStaff;
